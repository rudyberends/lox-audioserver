import type { ContentFolder, ContentFolderItem, ContentServiceAccount, PlaylistEntry } from '@/modules/content/types';
import { SpotifyAccountProvider, type SpotifyAccountState, type SpotifyAccountProviderOptions } from '@/modules/content/providers/spotify/spotifyAccountProvider';
import { MusicAssistantApi } from '@/modules/content/providers/musicassistant/musicAssistantApi';
import { createLogger } from '@/core/logging/logger';
import { DEFAULT_MIN_SEARCH_LIMIT } from '@/modules/content/utils/searchLimits';
...
export class MusicAssistantBridgeProvider extends SpotifyAccountProvider {
  ...
  private async buildMaRootFolder(offset: number): Promise<ContentFolder> {
    ...
    const recommendations = await this.api.getRecommendations().catch(() => []) as any[];
