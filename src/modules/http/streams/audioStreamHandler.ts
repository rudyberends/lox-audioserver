...
import { audioManager, type PlaybackSession } from '@/modules/audio';
import { audioStreamEngine } from '@/modules/audio/engine/audioStreamEngine';
import type { OutputProfile } from '@/modules/audio/engine/audioSession';
...
import { recordStreamRequest } from '@/modules/http/streams/streamEvents';
...
export class AudioStreamHandler {
  ...
  public async handle(
    ...
    const outputSettings = audioManager.getEffectiveOutputSettings(zoneId);
    const httpPrefs = audioManager.getHttpPreferences(zoneId);
